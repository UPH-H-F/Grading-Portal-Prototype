...
const MOCK_USERS = [
  { id: 'ADM-0921', name: 'Avery Anderson', role: 'Admin', department: 'System Administration', status: 'Active', avatar: 'https://i.pravatar.cc/150?u=avery' },
  { id: 'SUP-5543', name: 'Elias Jensen', role: 'Supervisor', department: 'Engineering', status: 'Active', avatar: 'https://i.pravatar.cc/150?u=elias' },
  { id: 'FAC-8821', name: 'Bennett Chen', role: 'Faculty', department: 'Computer Science', status: 'Active', avatar: 'https://i.pravatar.cc/150?u=bennett' },
  { id: 'FAC-7301', name: 'Marcus Tso', role: 'Faculty', department: 'Software Engineering', status: 'Inactive', avatar: 'https://i.pravatar.cc/150?u=marcus' },
  { id: 'STU-9482', name: 'Julian Alverez', role: 'Student', department: 'Faculty of Sciences', status: 'Active', avatar: 'https://i.pravatar.cc/150?u=julian' },
  { id: 'STU-8821', name: 'Elena Rostova', role: 'Student', department: 'Humanities', status: 'Active', avatar: 'https://i.pravatar.cc/150?u=elena' },
  { id: 'STU-1093', name: 'Daria Mikhailova', role: 'Student', department: 'Psychology', status: 'Active', avatar: 'https://i.pravatar.cc/150?u=daria' },
  { id: 'STU-6193', name: 'Sophia Garcia', role: 'Student', department: 'MD Surgery', status: 'Active', avatar: 'https://i.pravatar.cc/150?u=sophia' }
];
...
const MOCK_STUDENTS = [
  { id: '948271A', name: 'Julian Alverez', program: 'BSc. Theoretical Physics', yearLevel: 'Senior (Year 4)', department: 'Faculty of Sciences', avatar: 'https://i.pravatar.cc/150?u=julian' },
  { id: '882194C', name: 'Elena Rostova', program: 'MA Comparative Literature', yearLevel: 'Graduate (Year 1)', department: 'Humanities', avatar: 'https://i.pravatar.cc/150?u=elena' },
  { id: '109384B', name: 'Marcus Lin', program: 'BArch. Architecture', yearLevel: 'Junior (Year 3)', department: 'School of Design', avatar: 'https://i.pravatar.cc/150?u=marcus' },
  { id: '554329D', name: 'Sarah Jenkins', program: 'BSc. Computer Science', yearLevel: 'Sophomore (Year 2)', department: 'Engineering', avatar: 'https://i.pravatar.cc/150?u=sarah' },
  { id: '952140A', name: 'Liam Smith', program: 'BSc. Mathematics', yearLevel: 'Freshman (Year 1)', department: 'Faculty of Sciences', avatar: 'https://i.pravatar.cc/150?u=liam' },
  { id: '837462B', name: 'James O\'Connor', program: 'BA English Literature', yearLevel: 'Senior (Year 4)', department: 'Humanities', avatar: 'https://i.pravatar.cc/150?u=james' },
  { id: '726354C', name: 'David Chen', program: 'BSc. Information Technology', yearLevel: 'Junior (Year 3)', department: 'Computer Science', avatar: 'https://i.pravatar.cc/150?u=david' },
  { id: '841295B', name: 'Chloe Bennett', program: 'BA History', yearLevel: 'Sophomore (Year 2)', department: 'Humanities', avatar: 'https://i.pravatar.cc/150?u=chloe' },
];
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="flex gap-3 justify-end">
            <button onClick={onClose} className="px-5 py-2 text-sm font-bold text-gray-500 hover:bg-gray-100 rounded-lg">Cancel</button>
            <button onClick={onConfirm} className="px-6 py-2 text-sm font-bold text-white rounded-lg bg-[#800000] hover:bg-[#600000] shadow-md">Confirm Action</button>
          </div>
        </div>
      </div>
    </div>
            ...
            <form onSubmit={handleManualLogin} className="space-y-6">
              <div>
                ...
                <input 
                  ...
                  className="w-full h-12 px-4 border border-gray-300 rounded focus:border-[#800000] focus:ring-2 focus:ring-[#800000]/20 outline-none transition-all"
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <a href="#" className="text-xs text-[#800000] hover:underline font-semibold">Forgot Password?</a>
                </div>
                <input 
                  type="password" 
                  value={password}
  ...
  return (
    <div className="animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-6 gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Grade Encoding</h2>
          <p className="text-gray-500 text-sm mt-1">
            Subject: <span className="font-semibold text-gray-700">9408-AY-225-BSCS-2207-LEC (HCI 1)</span>
          </p>
        </div>
        ...
        {activeTab !== 'summary' && (
          <button 
            ...
            disabled={isSaving}
            className="bg-[#800000] text-white font-bold py-2.5 px-5 rounded-lg shadow-sm hover:bg-[#600000] transition-colors flex items-center gap-2 disabled:opacity-70"
          >
      ...
      {activeTab !== 'summary' ? (
        <>
          <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 mb-6 flex gap-3 text-sm text-blue-800">
            <Info size={20} className="flex-shrink-0 mt-0.5 text-blue-600" />
            <p>
              <strong>Encoding {activeTab.toUpperCase()}:</strong> White fields are <span className="font-bold underline">editable inputs</span>. 
              Fields with a gold background and lock icon (<Lock size={12} className="inline mx-0.5 text-[#800000]"/>) are <span className="font-bold underline">system-computed</span> and cannot be edited manually to prevent errors.
            </p>
          </div>
                  ...
                  {grades.map((student) => {
                    ...
                    return (
                      <tr key={student.studentId} className="hover:bg-gray-50 transition-colors group">
                        <td className="px-6 py-3 sticky left-0 bg-white group-hover:bg-gray-50 z-10 border-r border-transparent shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)]">
                          <div className="flex items-center gap-3">
                        ...
                        <td className="px-4 py-3 border-l border-gray-200 text-center">
                          <input type="number" value={student.periods[activeTab].attendance} onChange={(e) => handleGradeChange(student.studentId, 'attendance', e.target.value)} className="w-full text-center h-10 border border-gray-300 rounded focus:border-[#800000] focus:ring-1 focus:ring-[#800000] outline-none text-sm font-medium transition-all" />
                        </td>
                        <td className="px-4 py-3 border-l border-gray-200 text-center">
                          <input type="number" value={student.periods[activeTab].quizzes} onChange={(e) => handleGradeChange(student.studentId, 'quizzes', e.target.value)} className="w-full text-center h-10 border border-gray-300 rounded focus:border-[#800000] focus:ring-1 focus:ring-[#800000] outline-none text-sm font-medium transition-all" />
                        </td>
                        <td className="px-4 py-3 border-l border-gray-200 text-center">
                          <input type="number" value={student.periods[activeTab].project} onChange={(e) => handleGradeChange(student.studentId, 'project', e.target.value)} className="w-full text-center h-10 border border-gray-300 rounded focus:border-[#800000] focus:ring-1 focus:ring-[#800000] outline-none text-sm font-medium transition-all" />
                        </td>
                        ...
                        <td className="px-4 py-3 border-l border-gray-200 text-center">
                          <input type="number" value={student.periods[activeTab].exam} onChange={(e) => handleGradeChange(student.studentId, 'exam', e.target.value)} className="w-full text-center h-10 border border-gray-300 rounded focus:border-[#800000] focus:ring-1 focus:ring-[#800000] outline-none text-sm font-medium transition-all" />
                        </td>
                        <td className="px-4 py-3 border-l border-gray-200 bg-[#fafafa]">
    ...
    <div className="flex flex-col lg:flex-row gap-8">
      ...
      <div className="flex-grow min-w-0">
        ...
        {['subjects'].includes(activeTab) && (
          <div className="bg-white p-12 rounded-lg shadow-sm border border-gray-200 flex flex-col items-center justify-center text-center border-t-4 border-t-[#800000]">
            <BookOpen size={48} className="text-gray-300 mb-4" />
            <h3 className="text-xl font-semibold text-gray-700 mb-2">Module Under Construction</h3>
            <p className="text-gray-500 max-w-md">The My Subjects list is scheduled for development in a future phase.</p>
          </div>
        )}
      </div>
    </div>
...
const SupervisorDashboard = () => (
  <div className="p-8 animate-in fade-in duration-500">
    <div className="mb-8">
      ...
      <p className="text-gray-500">Departmental oversight, faculty assignments, and grade monitoring.</p>
    </div>
    <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 flex flex-col items-center justify-center text-center h-64 border-t-4 border-t-[#800000]">
      <LayoutDashboard size={48} className="text-gray-300 mb-4" />
      <h3 className="text-xl font-semibold text-gray-700">Supervisor Modules coming in Phase 5</h3>
      <p className="text-gray-500 mt-2 max-w-md">This area will contain Assign Subjects, Faculty Roster, and the read-only Oversight View.</p>
    </div>
  </div>
);
  ...
  return (
    <div className="min-h-screen bg-[#f3f4f5] font-sans pb-12 w-full">
      ...
      <style dangerouslySetInnerHTML={{__html: `
        /* Removing number arrows for cleaner inputs */
